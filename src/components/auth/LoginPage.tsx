...
import { Zap, Eye, EyeOff, AlertCircle, Wrench } from 'lucide-react'
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-slide-up relative">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand-500/10 border border-brand-500/20 mb-4 shadow-glow">
            <div className="relative">
              <Wrench className="w-7 h-7 text-brand-400 absolute -left-1 -top-1" />
          ...
          <p className="text-slate-400 text-sm font-medium tracking-wide">
            Hardware & Electricals — Store Management
          </p>
        </div>
        ...
        <p className="text-center text-slate-700 text-xs mt-6">
          © 2025 Selvaganapathy Hardware & Electricals
        </p>
      </div>
    </div>
  )
